...
const secureApi = jwt({
  secret: jwks.expressJwtSecret({
    ...
    jwksUri: "https://manage-api.auth0.com/.well-known/jwks.json"
  }),
  audience: 'https://courses-api',
  issuer: "https://manage-api.auth0.com/",
  algorithms: ['RS256']
});
...
// GET
// it's going to check secureApi first, then checkScopes before returning api data
